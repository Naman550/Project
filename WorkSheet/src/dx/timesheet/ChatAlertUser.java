 ...
 */
public class ChatAlertUser extends javax.swing.JDialog {
static Component c;
...
String message;
     ...
     */
    public ChatAlertUser(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public ChatAlertUser(Component c, boolean modal) {
    ...
    */
    ...
    private void initComponents() {
        ...
        lblInfo.setText("User Window Already Open");
    ...
    public void msgDialog(){
                ...
                ChatAlertUser dialog = new ChatAlertUser(new javax.swing.JFrame(), true);
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChatAlertUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
