...
/**
 *
 * This class will display the confirm dialog message in timeSheet
 */
public class ChatConfirmDialog extends javax.swing.JDialog {

    /**
     * Creates new form ConfirmDialog
     */
    String comments1="";
    public ChatConfirmDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        setLocationRelativeTo(ChattingWindow.staticLab);
        setAlwaysOnTop(true);
        setFocusableWindowState(true);
        setVisible(true);
    }
    
    public ChatConfirmDialog(Component c, boolean modal) {
        
    }
    
//     public String msgDialog(){
//            
//        ChatConfirmDialog dialog = new ChatConfirmDialog(new javax.swing.JFrame(), true);
//
...
//    }
    ...
    */
    ...
    private void initComponents() {
        ...
        lblInput3.setText("Do you want to clear chat!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChatConfirmDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
