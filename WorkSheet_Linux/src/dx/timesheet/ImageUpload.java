...
import java.util.logging.Logger;
 ...
 public class ImageUpload implements MediaHttpUploaderProgressListener{
    /** Application name. */
...
//        System.getProperty("user.home"), ".credentials/drive-java-quickstart");/home/developer/Downloads/WorkSheet/
   
   private static final java.io.File DATA_STORE_DIR = new java.io.File(".credentials/drive-java-quickstart");

//   private static final java.io.File DATA_STORE_DIR = new java.io.File("/home/developer/Downloads/WorkSheet/proj/.credentials/drive-java-quickstart");
    ...
    public static void main(String[] args) throws IOException {
     ...
     public void main(String fileName, String folderName,String percentage) throws IOException{
        ...
        insertFile(service, fileName, "ScreenShot Tracking","0B3iqPfSeaLwEUXZlOU1uNGNsVDA" ,"image/jpeg" ,
                "/home/"+Config.hostName+"/Downloads/Init/" + fileName + ".jpg",percentage);
        new HardwareDetails().deleteAllScreenshots();
    }
      ...
      try {
       ...
       //  URL url =new URL(Config.HTTP+Config.DOMAIN+"Tasks/getScreen/"+userId+"/"+task_id+"/"+fileId);
        ...
        return file;
          ...
          new HardwareDetails().errorDescription("ImageUpload.txt",e);
